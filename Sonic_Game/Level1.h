...
public:
	// constructor
	Level1(int l2, int l3, int width): Level(l2,l3, width) {
    ...
    "w                                                                                                                        b                                                                         w",
    "w     w           rrrrrr                                                                                                 b                                                                         w",
    "w       w         pppppp         www                        www                     ss                                   b                                                                         w",
    "w         qqrrrrrrrrrrrrrrrrrh      rrrr                   wwwwwww                 ssss              hqqqqqqq            b                                                                         w",
    ...
    "weeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeew",
    ...
    bool isLevelComplete() override {
        if (playerFactoryArray[activePlayerIndex]->getPlayer()->getX() > 11900 && ringCount<=10) { // if player reaches the end of the level
            return true;
        }
        else {
            return false;
